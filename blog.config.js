...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的计算机学生🍚', // 作者简介
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'https://www.chatbase.co/chatbot-iframe/XUN-Xjgl8BbEV6l2zIvO7',
